...
import { PartnerSupabaseController } from '@/controllers/supabase/partner.supabase.controller';
import { authenticate, authorize } from '@/middlewares/auth';

const router = Router();
const controller = new PartnerSupabaseController();
...
router.get('/type/:partnerType', controller.byType.bind(controller));
