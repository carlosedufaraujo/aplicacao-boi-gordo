...
import { PurchaseOrderSupabaseController } from '@/controllers/supabase/purchaseOrder.supabase.controller';
import { authenticate, authorize } from '@/middlewares/auth';

const router = Router();
const controller = new PurchaseOrderSupabaseController();
...
router.get('/stage/:stage', controller.byStage.bind(controller));
