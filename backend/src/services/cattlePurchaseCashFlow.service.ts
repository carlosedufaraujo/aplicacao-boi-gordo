  ...
  async createPurchaseCashFlows(purchaseId: string) {
    try {
      ...
      for (const cashFlow of cashFlows) {
        if (cashFlow.dueDate) {
          try {
            console.log('[CattlePurchase] Criando evento no calendário para:', cashFlow.description);
            ...
            console.log('[CattlePurchase] Evento criado com sucesso:', event.id);
          } catch (error: any) {
            console.error('[CattlePurchase] ERRO ao criar evento no calendário:', error.message);
