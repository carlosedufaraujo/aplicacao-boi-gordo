...
export const CompleteCalendar: React.FC = () => {
  ...
  // Eventos manuais (salvos pelo usuário) - inicialmente vazio, dados reais virão do Supabase
  ...
  const autoGeneratedEvents = useMemo((): CalendarEvent[] => {
      ...
      purchaseOrders.forEach(order => {
        ...
        if (order.expectedDeliveryDate) {
          events.push({
            ...
            title: `Entrega: ${order.orderNumber}`,
        ...
        if (order.paymentDueDate) {
          events.push({
            ...
            title: `Pagamento: ${order.orderNumber}`,
    ...
    return events;
  }, [purchaseOrders, expenses, revenues, cattleLots, autoGenerateEvents]);
  ...
  if (ordersLoading || expensesLoading || revenuesLoading || lotsLoading) {
    return (
        ...
        <DialogContent className="max-w-2xl">
          ...
          {selectedEvent ? (
            ...
            <Alert>
              ...
              <AlertDescription>
                Formulário de criação de eventos será implementado na próxima fase.
              </AlertDescription>
            </Alert>
          )}
