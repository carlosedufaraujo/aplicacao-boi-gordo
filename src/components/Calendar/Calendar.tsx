...
import { Calendar as CalendarIcon, CreditCard, Receipt, ChevronLeft, ChevronRight, ArrowUp, ArrowDown, TrendingUp, DollarSign, AlertTriangle, Search, Filter } from 'lucide-react';
