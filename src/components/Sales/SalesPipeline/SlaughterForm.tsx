...
export const SlaughterForm: React.FC<SlaughterFormProps> = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      slaughterQuantity: lot.currentQuantity,
  ...
  // Calculate carcass currentWeight
  ...
  const handleFormSubmit = (data: any) => {
    ...
    const ownFreightExpenses = expenses.filter(expense => 
      ...
      expense.metadata?.relatedOrderId === lot.purchaseId
    );
    ...
    ownFreightExpenses.forEach(freightExpense => {
      ...
      addFinancialAccount({
        ...
        amount: freightExpense.purchaseValue,
        dueDate: paymentDate,
        status: 'pending',
      ...
      addNotification({
        ...
        message: `Frete próprio de R$ ${freightExpense.purchaseValue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} do lote ${lot.lotNumber} foi lançado para pagamento`,
        type: 'info',
          ...
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 text-center">
                <div className="text-base font-bold text-b3x-navy-900">{lot.currentQuantity}</div>
                <div className="text-xs text-neutral-600">Animais Embarcados</div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 text-center">
                <div className="text-base font-bold text-b3x-navy-900">{(lot.exitWeight / lot.currentQuantity).toFixed(0)}</div>
