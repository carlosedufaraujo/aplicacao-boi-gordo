...
export const ShipmentForm: React.FC<ShipmentFormProps> = ({
  ...
  const { partners, penStatuses, penAllocations, cattleLots } = useAppStore();
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 text-center">
                <div className="text-base font-bold text-b3x-navy-900">
                  {penInfo ? penInfo.totalAnimals : lot.quantity}
                </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 text-center">
                <div className="text-base font-bold text-b3x-navy-900">
                  {penInfo 
                    ...
                    : (lot.estimatedWeight / lot.quantity).toFixed(0)
                  }
                </div>
                ...
                <div className="space-y-1">
                  {penInfo.lotsInPen.map(({ lot, allocation }) => (
                    <div key={lot?.id} className="flex justify-between text-xs">
                      ...
                      <span className="font-medium">{allocation.quantity} animais</span>
                    </div>
                  ))}
                </div>
              </div>
